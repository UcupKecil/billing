...
@section('content')
    ...
    <section class="content-header">
      ...
      <section class="content">
        ...
        <div class="card">
          ...
          <div class="card-body">
            <div class="table-responsive">
                @can('create_kategori')
                    <button type="button" class="my-3 btn btn-primary" onclick="create()">Tambah Role</button>
                @endcan
        ...
        @include('components.modals.role.create')
        @include('components.modals.role.edit')
        <!-- /.card -->
